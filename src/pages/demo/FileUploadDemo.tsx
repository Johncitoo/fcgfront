      ...
      <div className="grid gap-6">
        ...
        <Card>
          ...
          <CardContent className="text-sm text-gray-600 space-y-2">
            ...
            <p>4. Una vez subido, podrás ver, descargar o ver el thumbnail (si es imagen)</p>
            <p className="pt-2 border-t text-xs text-gray-500">
              Los archivos se almacenan en el servicio de storage y se guardan en la base de datos.
              El sistema genera automáticamente thumbnails para imágenes.
            </p>
          </CardContent>
        </Card>
      </div>
