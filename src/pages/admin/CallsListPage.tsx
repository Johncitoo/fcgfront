          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-sky-600 border border-sky-700 rounded-lg hover:bg-sky-700 transition-colors shadow-sm"
              >
